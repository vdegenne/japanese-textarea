...
export const SVG_GEMINI = html` <svg
	xmlns="http://www.w3.org/2000/svg"
	viewBox="0 0 48 48"
	width="100%"
	height="100%"
>
	<defs>
		<linearGradient id="a" x1="15%" y1="85%" x2="85%" y2="15%">
			<stop offset="0%" stop-color="#4285f4" />
			<stop offset="40%" stop-color="#9b72cb" />
			<stop offset="70%" stop-color="#d96570" />
			<stop offset="100%" stop-color="#f4af90" />
		</linearGradient>
	</defs>
	<path
		d="M24 0C24 13.25 13.25 24 0 24C13.25 24 24 34.75 24 48C24 34.75 34.75 24 48 24C34.75 24 24 13.25 24 0Z"
		fill="url(#a)"
	/>
</svg>`
